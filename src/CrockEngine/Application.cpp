...
int Application::Init() {
	...
	Camera camera(m_window, glm::vec3(0.0, 0.0, 5.0f));
	...
	Cube cube(glm::vec3(0.0f,  0.0f,  0.0f), glm::vec3(0.75));
	cube.Init();
	...
	//Shader shader("../src/CrockEngine/assets/shaders/basic.vert", "../src/CrockEngine/assets/shaders/basic.frag");
	Shader shader("../src/CrockEngine/assets/shaders/basic.vert", "../src/CrockEngine/assets/shaders/basic.frag");
	...
	while (!m_window->Closed()) {
		...
		m_window->Update();
		m_window->ClearColor(10, 60, 30, 255);

		// VAO->Bind();
		// EBO->Bind();
		// shader.EnableShader();
		// Hangle+=0.01, Vangle+=0.01;
		...
		// shader.SetUniformMat4GLM("camera", camera.CalculateMatrix(0.1f, 100.f));
